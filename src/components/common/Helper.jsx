...
export const TeamMemberSliderdata = [
  {
    ...
    info: [
      ...
      "Crypto Investment Export",
      "Ex-Accenture / PwC / Hewitt",
      "Imperial College",
      "Dot Connector",
    ],
  },
  ...
  },
  {
    ...
    info: [
      "Director and Co- Founder of iCo Capital Nanagement",
      "Co-Founder of Vaultex (Regulated and License Security Token Exchange in SG)",
      "Ex-Asset Management In UAE",
      "Ex-Energy Industry Expert",
    ],
  },
  {
    img: "/images/png/teerasak.png",
    heading: "Teerasak W.",
    profession: "INNOVATION",
    info: [
      "17 Years of Product Development Experiences",
      "Innovation Consulting Country Manager (BOLD GROUP)",
      "Ex-Head of innovation (Banking)",
    ],
  },
  {
    ...
    profession: "FINANCE",
    info: [
      " 7 Years Ex-Ernst&Young Audit Manager of Insurance Industry",
      "Ex-AVP Finace and Accounting of Krungthai Panich Insureance",
      "Own consulting Firm",
