        ...
        <div className="custom_container mx-auto">
          <div className="text-white">
            ...
            <p className="ff_poppins font-normal text-sm sm:text-base mb-5">
              This website is operated by CarbonFlow Co.,Ltd.(hereafter referred
              to as CarbonFlow). Throughout the site, the terms “we”, “us” and
              “our” refer to CarbonFlow. CarbonFlow offers this website,
            ...
            <p className="ff_poppins font-normal text-sm sm:text-base my-5">
              ...
              terms and conditions (“Terms & Conditions”, “Terms”), including
              those additional terms and conditions and policies referenced
              herein and/or available by hyperlink. These Terms & Conditions
            ...
            <p className="ff_poppins font-normal text-sm sm:text-base my-5">
              ...
              not access the website or use any services. If these Terms &
              Conditions are considered an offer, acceptance is expressly
              limited to these Terms & Conditions.
            </p>
            <p className="ff_poppins font-normal text-sm sm:text-base my-5">
              Any new features or tools which are added to the current store
              shall also be subject to the Terms & Conditions. You can review
              the most current version of the Terms & Conditions at any time on
              this page. We reserve the right to update, change or replace any
              part of these Terms & Conditions by posting updates and/or changes
            ...
            <p className="ff_poppins font-normal text-sm sm:text-base my-5">
              By agreeing to these Terms & Conditions, you represent that you
            ...
            <p className="ff_poppins font-normal text-sm sm:text-base my-5">
              You must not transmit any malicious software, viruses or any code
              of that nature.
            </p>
            <p className="ff_poppins font-normal text-sm sm:text-base my-5">
            ...
            <p className="ff_poppins font-normal text-sm sm:text-base my-5">
              ...
              make every effort to ensure trees are planted within 18 months of
              purchase.
            </p>
            <p className="ff_poppins font-normal text-sm sm:text-base my-5">
            ...
            <p className="ff_poppins font-normal text-sm sm:text-base my-5">
              ...
              non-infringement. In no case shall CarbonFlow, our directors,
            ...
            <p className="ff_poppins font-normal text-sm sm:text-base my-5">
              You agree to indemnify, defend and hold harmless CarbonFlow and
            ...
            <p className="ff_poppins font-normal text-sm sm:text-base my-5">
              ...
              to be severed from these Terms & Conditions, such determination
            ...
            <p className="ff_poppins font-normal text-sm sm:text-base my-5">
              ...
              agreement for all purposes. These Terms & Conditions are effective
              unless and until terminated by either you or us. You may terminate
              these Terms & Conditions at any time by notifying us that you no
            ...
            <p className="ff_poppins font-normal text-sm sm:text-base my-5">
              ...
              Conditions, we also may terminate this agreement at any time
            ...
            <p className="ff_poppins font-normal text-sm sm:text-base my-5">
              ...
              these Terms & Conditions shall not constitute a waiver of such
              right or provision.
            </p>
            <p className="ff_poppins font-normal text-sm sm:text-base my-5">
              These Terms & Conditions and any policies or operating rules
              ...
              to, any prior versions of the Terms & Conditions).
            </p>
            <p className="ff_poppins font-normal text-sm sm:text-base my-5">
            ...
            <p className="ff_poppins font-normal text-sm sm:text-base my-5">
              You can review the most current version of the Terms & Conditions
              at any time at this page. We reserve the right, at our sole
              discretion, to update, change or replace any part of these Terms &
              Conditions by posting updates and changes to our website. It is
            ...
            <p className="ff_poppins font-normal text-sm sm:text-base my-5">
              All information, text and images is the copyright of CarbonFlow,
              except for the logos and quotes of the various companies and
              organisations listed on our website pages. For example the
              Mastercard logo and the word Mastercard, is are registered
              trademarks of Mastercard International and are the property of
              Mastercard International. The JGR Biogeosciences by AGU and word
              JGR Biogeosciences by AGU are trademarks of Amazon Web Services.
              CEOS word and logo are registered trademarks of CEOS. GISTDA name
              and logo are registered trademarks, and are the property of
              GISTDA.
            </p>
          </div>
        </div>
