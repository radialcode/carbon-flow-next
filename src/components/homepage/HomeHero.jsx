        ...
        <div className=" container xl:max-w-[1140px] 3xl:max-w-[1320px] px-3 xl:px-0 flex flex-grow mx-auto">
          <div className=" flex flex-col lg:flex-row items-center lg:justify-between ">
            ...
            <div className="w-full xs:w-[75%] lg:w-1/2">
              <div className="hero_clipPath  lg:absolute right-1/2 mt-[88px] 2xsm:mt-[32px] xsm:mt-[90px]  sm:mt-24 md:mt-[80px]  bottom-[-60px] xl:bottom-[-120px] lg:right-[-60px] xl:right-[-80px] 4xl:right-0 4xl:bottom-0">
                <Image
                  ref={ref}
                  priority={true}
