        ...
        <div className="custom_container w-full h-full mx-auto">
          <div className="flex flex-col items-center lg:flex-row justify-between h-full">
            ...
            <div
              className={`${
                loader
                  ? "loader_border z-[999] absolute top-[50%] right-[50%] translate-x-[38%] -translate-y-[50%] duration-[2s] max-w-[100px] h-[100px] p-[1] hero_clipPath"
              ...
              <Image
                ...
                className={`object-cover md:w-full md:h-full ${
                  ...
                  loader
                    ...
                    : "max-w-[330px] md:max-w-none h-[390px] bg-[#235C02]"
                } `}
                src={`${loader ? "" : "/images/png/satelite.png"}`}
                width={808}
                height={846}
                alt="blockchain"
              />
