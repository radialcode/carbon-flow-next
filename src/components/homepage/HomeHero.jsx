...
const HomeHero = () => {
  ...
  return (
    <>
      <div className="bg-[#061E10] min-h-screen flex flex-col overflow-hidden relative pt-[130px] md:pt-[120px] 3xl:pt-0">
        <a
        ...
        <div className=" container xl:max-w-[1140px] 3xl:max-w-[1320px] px-3 xl:px-0 flex flex-grow mx-auto">
          <div className=" flex flex-col lg:flex-row items-center lg:justify-between ">
            ...
            <div className="w-full xs:w-[75%] lg:w-1/2">
              <div className="animate_loader hero_clipPath z-[999] absolute -bottom-[51px] xl:bottom-[-120px] xl:right-[-88px] right-[-8%]">
                <Image
                  ref={ref}
                  priority={true}
