        ...
        <div className="container xl:max-w-[1140px] 3xl:max-w-[1320px] mx-auto px-3 xl:px-0 z-10 relative">
          ...
          <Slider {...settings} className="flex flex-wrap mx-[-12px]">
            {TeamMemberSliderdata.map((data, index) => {
              return (
                <div className="w-3/12 h-full flex" key={index}>
                  <div className="border-2 border-[#E6E9E7] hover:border-[#D2F958] rounded-[10px] h-full w-full">
                    <div className="px-[76px] md:px-[79px] py-[22px]">
                      <span>{data.svgicon}</span>
                      <h2 className="ff_AktivGrotesk_bold font-normal text-[20px] text-[#061E10] text-center mb-0 mt-[24px] leading-[24.04px]">
                        {data.heading}
                      </h2>
